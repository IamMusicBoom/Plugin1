package com.optima.plugin.plugin1.provider;
...
import com.optima.plugin.plugin1.activity.ProviderTestActivity;
...
public class Plugin1Provider extends ContentProvider {
    String TAG = Plugin1Provider.class.getSimpleName();
